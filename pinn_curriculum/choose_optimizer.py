# Original code:
# https://github.com/a1k12/characterizing-pinns-failure-modes/blob/main/pbc_examples/choose_optimizer.py

"""Optimizer choices."""

import torch
import torch_optimizer as optim # oops this is a different package!
